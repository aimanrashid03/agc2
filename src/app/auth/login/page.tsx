      ...
      <div className="auth-enter flex w-full max-w-6xl min-h-[680px] lg:min-h-[760px] bg-white shadow-2xl ring-1 ring-slate-200/70 overflow-hidden lg:flex-row flex-col">
        <section className="hidden lg:flex lg:w-3/5 judicial-wash relative p-14 xl:p-16 flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/75 mt-6 text-lg font-light leading-relaxed max-w-md">
              Akses ke portal dihadkan kepada pegawai AGC yang dibenarkan.
              Setiap interaksi direkod dan diaudit.
            </p>
          </div>
        ...
        <section className="flex-1 flex flex-col justify-center px-8 py-10 sm:px-12 lg:px-16 bg-white">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-gray-900 text-3xl font-bold tracking-tight mb-2">Pengesahan Akses</h2>
              <p className="text-slate-500 text-sm font-medium">
                Masukkan kelayakan anda untuk menguruskan daftar kes.
              </p>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between pt-2">
                <label className="flex items-center cursor-pointer group">
                  ...
                  <span className="ml-2 text-xs font-semibold text-slate-500 group-hover:text-gray-800 transition-colors">
                    Kekalkan sesi log masuk
                  </span>
                </label>
                <Link
                  href="/auth/forgot-password"
                  className="text-xs font-bold text-primary-700 hover:text-primary-800 underline-offset-2 hover:underline"
                >
                  Lupa Kata Laluan?
                </Link>
              </div>
              ...
              >
                <span>{isSubmitting ? 'SEDANG MENGESAHKAN...' : 'SAHKAN AKSES'}</span>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-red-900/80 text-xs leading-relaxed">
                    Ini ialah sistem kerajaan yang selamat. Cubaan akses tanpa kebenaran dipantau
                    dan boleh didakwa di bawah Akta Jenayah Komputer serta Akta Rahsia Rasmi.
                  </p>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-600">
              Tiada akaun?{' '}
              <Link href="/auth/sign-up" className="text-primary-700 hover:text-primary-800 font-semibold">
                Daftar di sini
              </Link>
            </p>
          </div>
